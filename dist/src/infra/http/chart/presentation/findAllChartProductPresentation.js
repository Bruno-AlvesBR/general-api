...
let findAllChartProductPresentation = class findAllChartProductPresentation {
    handle({ userId, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return productsIntoChart !== null && productsIntoChart !== void 0 ? productsIntoChart : [];
        });
    }
};
findAllChartProductPresentation = __decorate([
    (0, tsyringe_1.injectable)()
], findAllChartProductPresentation);
exports.default = findAllChartProductPresentation;
