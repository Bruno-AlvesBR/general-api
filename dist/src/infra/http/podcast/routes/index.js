...
const PodcastUpdateController_1 = __importDefault(require("../controllers/PodcastUpdateController"));
const PodcastDeleteController_1 = __importDefault(require("../controllers/PodcastDeleteController"));
...
const podcastUpdateController = new PodcastUpdateController_1.default();
const podcastDeleteController = new PodcastDeleteController_1.default();
