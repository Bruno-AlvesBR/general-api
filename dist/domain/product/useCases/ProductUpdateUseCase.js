...
let ProductUpdateUseCase = class ProductUpdateUseCase {
    ...
    execute(requestDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.productDataProvider.update(requestDTO === null || requestDTO === void 0 ? void 0 : requestDTO.id, requestDTO === null || requestDTO === void 0 ? void 0 : requestDTO.data);
        });
    }
};
